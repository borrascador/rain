  ...
  _createClass(Connect, [{
    ...
    get: function get() {
      var _store$getState4 = this.store.getState(),
          xDown = _store$getState4.xDown,
          yDown = _store$getState4.yDown;

      return { xDown: xDown, yDown: yDown };
    }
  }, {
    key: 'drop',
    get: function get() {
      var _store$getState5 = this.store.getState(),
          xDrop = _store$getState5.xDrop,
          yDrop = _store$getState5.yDrop;

      return { xDrop: xDrop, yDrop: yDrop };
    }
  }, {
    key: 'stories',
    get: function get() {
    ...
    get: function get() {
      var _store$getState6 = this.store.getState(),
          position = _store$getState6.position,
          xCoord = _store$getState6.xCoord,
          yCoord = _store$getState6.yCoord,
          positionTarget = _store$getState6.positionTarget,
          xTarget = _store$getState6.xTarget,
          yTarget = _store$getState6.yTarget,
          tiles = _store$getState6.tiles,
          sight = _store$getState6.sight,
          zoom = _store$getState6.zoom;
    ...
    get: function get() {
      var _store$getState7 = this.store.getState(),
          position = _store$getState7.position,
          tiles = _store$getState7.tiles;
